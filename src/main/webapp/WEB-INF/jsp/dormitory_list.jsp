        ...
        <div class="layui-col-md10">
            <form class="layui-form" id="addEmployeeForm">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="bed_count" class="layui-input" placeholder="请输入床位总数">
                    </div>
                </div>

                <div class="layui-form-item">
                    <label class="layui-form-label">床位已用数：</label>
                    <div class="layui-input-block">
                        <input type="text" name="bed_num" class="layui-input" placeholder="请输入宿舍楼">
                    </div>
                </div>
...
<c:forEach items="${di.list}" var="di">
        <tr>
            ...
            <td>${di.bed_num}</td>
            <td>
                <a title="编辑" id= "updateEdit"  href="/findDormitoryById?dorm_id=${di.dorm_id}">
                    <i class="layui-icon">&#xe642;</i>
                </a>
                <a title="删除" onclick="member_del(this,'${di.dorm_id}')" href="javascript:;">
                    <i class="layui-icon">&#xe640;</i>
                </a>
            </td>
        </tr>
