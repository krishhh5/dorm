...
<div class="x-nav">
      <span class="layui-breadcrumb">
        <a href="">首页</a>
        <a href="/applydorm">宿舍信息</a>

      </span>
    <a class="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:3px;float:right" href="/findDorm" title="刷新">
        <i class="layui-icon" style="line-height:30px">ဂ</i></a>
</div>
<div class="x-body">
    <div class="layui-row">
        <form class="layui-form layui-col-md12 x-so" action="/findDorm" >
            <input class="layui-input" placeholder="请输入学号查询宿舍" name="user_name" id="user_name">
    ...
    <xblock>
        <button id="addStudnetBtn" class="layui-btn layui-btn-normal"> <i class="layui-icon">&#xe654;</i>填写申请表</button>
            ...
            <form class="layui-form" id="addEmployeeForm">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="dorm_num" class="layui-input" placeholder="请输入宿舍编号">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" lay-verify="required" name="s_num"   class="layui-input" placeholder="请输入学号">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="s_class" class="layui-input" placeholder="请输入班级编号">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="s_address" class="layui-input" placeholder="请输入家庭住址">
                    </div>
                </div>
            ...
            form.on('submit(formDemo)', function(data) {
                ...
                $.ajax({
                    ...
                    success:function(){
                            ...
                            setTimeout(function () {window.location.href='/applydorm';},2000);
