...
<div class="container">
    ...
    <ul class="layui-nav right" lay-filter="">
        <li class="layui-nav-item">
            <a href="javascript:;">
<%--                <img src="/images/01.jpg" class="layui-nav-img">--%>
...
<%--                <a href="javascript:;">--%>
<%--                    &lt;%&ndash;                <img src="http://m.zhengjinfan.cn/images/0.jpg" class="layui-nav-img">&ndash;%&gt;--%>
<%--                    ${sessionScope.u.user_name}</a>--%>
<%--                <span class="o_span">${sessionScope.u.user_name}维修员，欢迎来到宿舍管理系统！</span>--%>
                ...
                <div class="layui-card-header">个人信息
                        ...
                        <div class="layui-card-body">
                            姓名：${sessionScope.u.user_name}
                        </div>
                        <div class="layui-card-body">
                            电话：${sessionScope.u.user_name}
                        </div>
                </div>
                </div>
            </div>
